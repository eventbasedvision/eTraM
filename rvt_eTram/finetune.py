...
def main(config: DictConfig):
    ...
    # for params in module.mdl.backbone.parameters():
    #     print(params[0][0])
    #     break
    # print("FPN Params")
    # for params in module.mdl.fpn.parameters():
    #     print(params[0][0])
    #     break
    # print("Head Params")
    # for params in module.mdl.yolox_head.parameters():
    #     print(params[0][0])
    #     break
